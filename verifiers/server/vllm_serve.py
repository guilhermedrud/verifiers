...
def main(script_args: ScriptArguments):
    ...
    async def generate_multimodal(request: GenerateRequestMultimodal):
        """
        ...
        # Por agora, apenas uma imagem por prompt
        prompt_text = request.prompts[0]['prompt']
        image_url = request.prompts[0]['image']
        ...
        all_outputs = llm.generate({
            "prompt": prompt_format.format(prompt_text),
