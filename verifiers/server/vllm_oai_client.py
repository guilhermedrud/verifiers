...
class VLLMClient:
    ...
    def generate_multimodal(
        ...
        url = f"http://{self.host}:{self.server_port}/generate_multimodal"
...
if __name__ == "__main__":
    ...
    # Generate completions
    responses = client.generate_multimodal([{"prompt": "Whats in this image?", "image": "/mnt/disk1/luanborges/verifiers_vlm/images/duck.jpg"}], n=1)
    print("Responses:", responses)  # noqa
